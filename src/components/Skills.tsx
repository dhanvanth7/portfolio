...
const skillCategories: SkillCategory[] = [
  {
    ...
    categoryIcon: <FaCode className="text-emerald-400" size={15} />,
    skills: [
  ...
  },
  {
    ...
    categoryIcon: <FaLayerGroup className="text-teal-400" size={15} />,
    skills: [
  ...
  },
  {
    ...
    categoryIcon: <FaDatabase className="text-emerald-400" size={15} />,
    skills: [
  ...
  },
  {
    ...
    categoryIcon: <FaTools className="text-amber-400" size={15} />,
    skills: [
              ...
              <div>
                <div className="flex items-center justify-between pb-4 mb-6 border-b border-white/5">
                  <div className="flex items-center gap-3.5">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-white/5 border border-white/10 shrink-0">
                  ...
                  <span className="text-xs font-mono text-slate-400 px-3 py-1 rounded-full bg-slate-900/80 border border-white/5">
          ...
          <div className="glass-card rounded-2xl p-6 md:p-8">
            ...
            <div className="flex flex-wrap gap-3">
              {softSkills.map((item) => (
                <div
                  key={item.name}
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-xs md:text-sm font-medium transition-all duration-200 hover:border-emerald-500/40 cursor-default bg-slate-900/70 border border-white/10 text-slate-200"
                >
