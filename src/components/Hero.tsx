      ...
      <div className="section-container relative z-10 w-full">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <motion.div
            ...
            className="text-lg sm:text-2xl md:text-3xl font-semibold text-slate-200 mb-8 flex items-center justify-center gap-2.5 flex-wrap"
          >
          ...
          {/* Authentic Developer Bio with comfortable line height */}
          <motion.p
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.3 }}
            className="max-w-2xl text-base sm:text-lg md:text-xl text-slate-300 leading-relaxed mb-12 font-normal"
          >
